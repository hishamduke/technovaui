          ...
          <div>
            <div className="sidebar">
              <ul className="sidebarlist">
                ...
                <li
                  className="row"
                  onClick={() => setSelectedComponent("LevelOne1")}
                >
                  <div id="icon">
                ...
                <li
                  className="row"
                  onClick={() => setSelectedComponent("LevelOne2")}
                >
                  <div id="icon">
                    <i className="fa-regular fa-pen-to-square"></i>
                  </div>{" "}
                ...
                <li
                  className="row"
                  onClick={() => setSelectedComponent("LevelOne3")}
                >
                  <div id="icon">
                    <i className="fa-regular fa-pen-to-square"></i>
                  </div>{" "}
                ...
                <li
                  className="row"
                  onClick={() => setSelectedComponent("LevelOne4")}
                >
                  <div id="icon">
                    <i className="fa-regular fa-pen-to-square"></i>
                  </div>{" "}
                ...
                <li
                  className="row"
                  onClick={() => setSelectedComponent("LevelOne5")}
                >
                  <div id="icon">
                    <i className="fa-regular fa-pen-to-square"></i>
                  </div>{" "}
