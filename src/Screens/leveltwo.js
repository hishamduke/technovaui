...
const LevelTwo = () => {
  ...
  const renderComponent = () => {
    switch (selectedComponent) {
      case "LevelTwo1":
        return <LevelTwo1 setSelectedComponent={setSelectedComponent} />;
      case "LevelTwo2":
        return <LevelTwo2 setSelectedComponent={setSelectedComponent} />;
      case "LevelTwo3":
        return <LevelTwo3 setSelectedComponent={setSelectedComponent} />;
      case "LevelTwo4":
        return <LevelTwo4 setSelectedComponent={setSelectedComponent} />;
      default:
        return null;
    }
  };
